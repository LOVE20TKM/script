...
class TimelineRuntimeTest(unittest.TestCase):
    def test_tracked_pair_labels_include_grow20_lively_and_pretty(self) -> None:
        ...
        self.assertEqual(timeline_runtime.token_label("prettyTusdtPair"), "PRETTY/TUSDT LP")
        ...
        self.assertEqual(timeline_runtime.token_label("love20PrettyPair"), "LOVE20/PRETTY LP")
        self.assertEqual(
        ...
        self.assertEqual(
            timeline_runtime.infer_lp_label_for_token(TOKEN, {TOKEN: "PRETTY"}),
            "LOVE20/PRETTY LP",
        )
